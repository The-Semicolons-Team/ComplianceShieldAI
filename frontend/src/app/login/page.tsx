    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Welcome to ComplianceShield</h1>
        ...
        <div className="card">
          ...
          <button 
            ...
            type="button"
            className="flex items-center justify-center w-full px-6 py-4 border-2 border-gray-300 rounded-lg bg-white hover:bg-gray-50 hover:border-primary-300 transition-all shadow-sm hover:shadow-md group"
          >
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-blue-800">Secure Gmail Access</p>
                <p className="text-xs text-blue-700 mt-1">
                  We'll request read-only access to your Gmail to monitor government compliance notifications. Your data is secure and never shared.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600 mb-4">By signing in, you get access to:</p>
